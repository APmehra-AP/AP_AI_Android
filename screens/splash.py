...
class SplashScreen(MDScreen):
    ...
    def __init__(self, **kwargs):
        ...
        self.name = "splash"
        self.md_bg_color = get_color_from_hex(BACKGROUND)
    ...
    def on_enter(self, *args):
        Animation(opacity=1, duration=0.8).start(self.logo)
        Animation(opacity=1, duration=1.0).start(self.title)
        Animation(opacity=1, duration=1.2).start(self.subtitle)
